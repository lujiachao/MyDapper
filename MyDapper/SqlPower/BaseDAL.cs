...
namespace MyDapper.SqlPower
{
    ...
    public partial class BaseDAL<T> where T : class
    {
        ...
        public BaseDAL()
        {
            ...
            //切记 需要手动引用 using Microsoft.Extensions.DependencyInjection;
            _connectionFactory = MyDapperExtension.serviceProvider.GetService<IConnectionFactory>();
        }
        ...
        /// </summary>
        /// <returns></returns>
        public IEnumerable<T> GetAll(IDbConnection dbConnection)
        {
            return dbConnection.GetAll<T>();
        }
        ...
        /// <param name="id">主键的值</param>
        /// <returns></returns>
        public T FindByID(IDbConnection dbConnection, object id)
        {
            return dbConnection.Get<T>(id);
        }
        ...
        /// <param name="info">指定的对象</param>
        /// <returns></returns>
        public bool Insert(IDbConnection dbConnection, T info)
        {
            bool result = false;
        ...
        /// <param name="list">指定的对象集合</param>
        /// <returns></returns>
        public bool Insert(IDbConnection dbConnection, IEnumerable<T> list)
        {
            bool result = false;
            result = dbConnection.Insert(list) > 0;
            return result;
        ...
        /// <param name="info">指定的对象</param>
        /// <returns></returns>
        public bool Update(IDbConnection dbConnection, T info)
        {
            bool result = false;
            result = dbConnection.Update(info);
            return result;
        ...
        /// <param name="list">指定的对象集合</param>
        /// <returns></returns>
        public bool Update(IDbConnection dbConnection, IEnumerable<T> list)
        {
            bool result = false;
            result = dbConnection.Update(list);
            return result;
        ...
        /// <param name="info">指定的对象</param>
        /// <returns></returns>
        public bool Delete(IDbConnection dbConnection, T info)
        {
            bool result = false;
            result = dbConnection.Delete(info);
            return result;
        ...
        /// <param name="list">指定的对象集合</param>
        /// <returns></returns>
        public bool Delete(IDbConnection dbConnection, IEnumerable<T> list)
        {
            bool result = false;
            result = dbConnection.Delete(list);
            return result;
        ...
        /// <param name="id">对象的ID</param>
        /// <returns></returns>
        public bool Delete(IDbConnection dbConnection,object id)
        {
            bool result = false;
            string query = string.Format("DELETE FROM {0} WHERE id = @id", TableName);
            var parameters = new DynamicParameters();
        ...
        /// </summary>
        /// <returns></returns>
        public bool DeleteAll(IDbConnection dbConnection)
        {
            bool result = false;
            result = dbConnection.DeleteAll<T>();
            return result;
